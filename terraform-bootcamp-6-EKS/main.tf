...
# output :
# D:\Projects\terraform-bootcamp-6-EKS>aws eks update-kubeconfig --name  anantha-eks_cluster && kubectl get nodes
# Added new context arn:aws:eks:us-east-2:419835568062:cluster/anantha-eks_cluster to C:\Users\anantha.subramanian\.kube\config
